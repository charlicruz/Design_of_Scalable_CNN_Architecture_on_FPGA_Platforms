...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot ReLU_0 xil_defaultlib.ReLU_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ReLU_0 -key {Behavioral:sim_1:Functional:ReLU_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ReLU_0.wdb xsim.dir)
